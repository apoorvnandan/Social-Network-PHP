...
runthis('CREATE TABLE Premium_User (
  user_id         INT       PRIMARY KEY AUTO_INCREMENTS,
...
runthis('CREATE TABLE Dog_Joins_Group (
  d_id            INT       PRIMARY KEY AUTO_INCREMENTS,
  group_id        INT       PRIMARY KEY AUTO_INCREMENTS,
  since           DATE,
...
runthis('CREATE TABLE Premium_Profile_Page (
  profile_id            INT         PRIMARY KEY AUTO_INCREMENTS,
  premium_swag_id       INT,
  FOREIGN KEY(profile_id) REFERENCES Dog_Has_Profile_Page(profile_id)
      ON DELETE CASCADE,
